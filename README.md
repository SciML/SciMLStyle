...
random cookie is necessary to successfully connect (Julia v0.5 onwards), which defeats arbitrary external connections. This mechanism is described in detail in <https://github.com/JuliaLang/julia/pull/16292>.
